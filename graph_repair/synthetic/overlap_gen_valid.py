...
class OverlapGenerator:
    """
    This class builds the actual graph in Neo4j using the rules created by the 
    OverlapOntologyGenerator class inside overlap_rules_maker.py. It makes sure 
    every node and edge it creates follows the rules perfectly before we start breaking them.
    """
    ...
    def generate_valid_graph(self, num_nodes=None):
        ...
        It adds properties and connections while strictly following the allowed rules made by overlap_rules_maker.py,
