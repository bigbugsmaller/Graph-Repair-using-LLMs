...
UNWIND [{_id:15, properties:{x:47, id:"node_15"}}, {_id:21, properties:{x:66, id:"node_21"}}, {_id:26, properties:{x:71, id:"node_26"}}, {_id:28, properties:{x:71, id:"node_28"}}, {_id:38, properties:{x:93, id:"node_38"}}, {_id:46, properties:{x:68, id:"node_46"}}] AS row
...
:commit
:begin
UNWIND [{start: {_id:8}, end: {_id:1}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R1]->(end) SET r += row.properties;
UNWIND [{start: {_id:0}, end: {_id:2}, properties:{}}, {start: {_id:9}, end: {_id:29}, properties:{}}, {start: {_id:14}, end: {_id:19}, properties:{}}, {start: {_id:25}, end: {_id:19}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R1]->(end) SET r += row.properties;
...
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R3]->(end) SET r += row.properties;
UNWIND [{start: {_id:15}, end: {_id:2}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R3]->(end) SET r += row.properties;
UNWIND [{start: {_id:0}, end: {_id:1}, properties:{}}, {start: {_id:0}, end: {_id:3}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R1]->(end) SET r += row.properties;
UNWIND [{start: {_id:1}, end: {_id:8}, properties:{}}, {start: {_id:3}, end: {_id:8}, properties:{}}, {start: {_id:3}, end: {_id:10}, properties:{}}, {start: {_id:3}, end: {_id:11}, properties:{}}, {start: {_id:3}, end: {_id:12}, properties:{}}, {start: {_id:3}, end: {_id:22}, properties:{}}, {start: {_id:3}, end: {_id:23}, properties:{}}, {start: {_id:3}, end: {_id:32}, properties:{}}, {start: {_id:3}, end: {_id:35}, properties:{}}, {start: {_id:3}, end: {_id:36}, properties:{}}, {start: {_id:3}, end: {_id:41}, properties:{}}, {start: {_id:3}, end: {_id:47}, properties:{}}, {start: {_id:3}, end: {_id:49}, properties:{}}, {start: {_id:16}, end: {_id:8}, properties:{}}, {start: {_id:16}, end: {_id:10}, properties:{}}, {start: {_id:16}, end: {_id:12}, properties:{}}, {start: {_id:16}, end: {_id:22}, properties:{}}, {start: {_id:16}, end: {_id:23}, properties:{}}, {start: {_id:16}, end: {_id:32}, properties:{}}, {start: {_id:16}, end: {_id:36}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R1]->(end) SET r += row.properties;
UNWIND [{start: {_id:16}, end: {_id:47}, properties:{}}, {start: {_id:16}, end: {_id:49}, properties:{}}, {start: {_id:20}, end: {_id:10}, properties:{}}, {start: {_id:20}, end: {_id:12}, properties:{}}, {start: {_id:20}, end: {_id:22}, properties:{}}, {start: {_id:20}, end: {_id:23}, properties:{}}, {start: {_id:20}, end: {_id:32}, properties:{}}, {start: {_id:20}, end: {_id:41}, properties:{}}, {start: {_id:44}, end: {_id:23}, properties:{}}, {start: {_id:44}, end: {_id:41}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R1]->(end) SET r += row.properties;
...
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R2]->(end) SET r += row.properties;
UNWIND [{start: {_id:0}, end: {_id:4}, properties:{}}, {start: {_id:0}, end: {_id:5}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R1]->(end) SET r += row.properties;
...
UNWIND [{start: {_id:15}, end: {_id:0}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
CREATE (start)-[r:R3]->(end) SET r += row.properties;
